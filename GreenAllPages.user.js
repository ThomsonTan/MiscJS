...
if (document.URL.indexOf("http://stackoverflow.com") == 0) {
    ...
    style.innerHTML = "html, body .Bu{background-color: #8ACA9A!important;line-height: 1.1em;font-size:30px;font-family: Open Sans,Book Antiqua,verdana,serif;} body .hP{background-color: yellow} h3{background-color: gray}";
}
